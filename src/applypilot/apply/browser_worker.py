...
Soft phone check: inspect the rendered flag/prefix and number for duplication or wrong inferred country. Separate prefixes usually take national digits; international-number widgets may need the full profile number. Consider screenshots for inconclusive DOM values or recheck after parsing/country changes. No new hard gate or mandatory tool call.
